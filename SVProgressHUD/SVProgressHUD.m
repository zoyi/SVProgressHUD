...
+ (void)showInfoWithStatus:(NSString *)string maskType:(SVProgressHUDMaskType)maskType autoDisappear:(BOOL)disappear {
  [self sharedView];
  [self showImage:SVProgressHUDInfoImage status:string maskType:maskType autoDisappear:disappear];
}
...
+ (void)showSuccessWithStatus:(NSString *)string maskType:(SVProgressHUDMaskType)maskType autoDisappear:(BOOL)disappear {
  [self sharedView];
  [self showImage:SVProgressHUDSuccessImage status:string maskType:maskType autoDisappear:disappear];
}
...
+ (void)showErrorWithStatus:(NSString *)string maskType:(SVProgressHUDMaskType)maskType autoDisappear:(BOOL)disappear {
  [self sharedView];
  [self showImage:SVProgressHUDErrorImage status:string maskType:maskType autoDisappear:disappear];
}
...
+ (void)showImage:(UIImage *)image status:(NSString *)string maskType:(SVProgressHUDMaskType)maskType {
  [self showImage:image status:string maskType:maskType autoDisappear:true];
}

+ (void)showImage:(UIImage*)image status:(NSString*)string maskType:(SVProgressHUDMaskType)maskType autoDisappear:(BOOL)disappear {
  NSTimeInterval displayInterval = -1;
  if (disappear) {
    displayInterval = [[self sharedView] displayDurationForString:string];
  }
